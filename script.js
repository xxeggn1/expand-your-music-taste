...
const MANUAL_ALBUMS = [
  ...
  { artist:'Radiohead', name:'Kid A', year:2000, genreTag:'experimental',
  ...
  { artist:'Rage Against the Machine', name:'Rage Against the Machine', year:1992, genreTag:'metal',
  ...
  { artist:'Amy Winehouse', name:'Back to Black', year:2006, genreTag:'soul',
    tags:['melancholic','groovy','late night'] },
